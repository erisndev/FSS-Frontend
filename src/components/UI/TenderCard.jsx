  ...
  const getStatusConfig = (status) => {
    switch ((status || "").toUpperCase()) {
      case "ACTIVE":
        return {
          text: "Active",
          color: "text-emerald-400 bg-emerald-400/15 border-emerald-400/25",
          bar: "from-emerald-400 to-green-500",
        };
      case "CLOSED":
        return {
          text: "Closed",
          color: "text-red-400 bg-red-400/15 border-red-400/25",
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 text-gray-300 text-xs">
              ...
              <span className="truncate">
                {tender.companyName || tender.category}
              </span>
            </div>
          </div>
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            <span
              className={`px-2 py-0.5 text-[10px] font-semibold rounded-full border ${statusConfig.color}`}
            >
              {statusConfig.text}
            </span>
          </div>
        ...
        <div className="bg-slate-800/40 border border-white/[0.04] rounded-xl p-3 mb-4">
          <p className="text-[10px] text-gray-300 uppercase tracking-wider font-medium mb-1">
            Budget
          </p>
