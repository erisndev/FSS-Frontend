...
const TenderFilters = ({
  ...
  return (
    <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-4 sm:p-5">
      {/* Search Bar */}
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-800/50 border border-white/[0.06] rounded-xl text-white text-sm placeholder-gray-400 focus:outline-none focus:border-cyan-400/40 focus:ring-1 focus:ring-cyan-400/20 focus:bg-slate-800/70 transition-all duration-200"
          />
          {filters.search && (
            <button
