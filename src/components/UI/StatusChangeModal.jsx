      ...
      >
        ...
        <div className="flex items-start justify-between mb-6 border-b border-cyan-400/10 pb-4">
          <div className="flex items-center space-x-3">
            <div
              className={`w-12 h-12 rounded-xl bg-gradient-to-br ${isAccept ? "from-green-500/20 to-emerald-500/20" : "from-red-500/20 to-orange-500/20"} flex items-center justify-center`}
            >
              {isAccept ? (
