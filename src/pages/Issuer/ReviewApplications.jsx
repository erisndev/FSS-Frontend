...
const ReviewApplications = () => {
  ...
  const chipColors = {
    ...
    gray: {
      active:
        "bg-gray-500/20 border-gray-400/50 text-gray-300 shadow-gray-500/10",
      inactive:
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-800/50 border border-cyan-400/20 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/20 transition-all duration-300"
                />
                {searchTerm && (
                  <button
